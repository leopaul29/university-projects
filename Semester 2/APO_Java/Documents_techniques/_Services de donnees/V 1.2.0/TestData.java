...
//
// Tests unitaires de la classe Data - Version 1.2.0
//
//
...
public static void main (String [] args) throws Exception{
   Tests.Begin("Data", "A - 1.2.0");
      ...
      Tests.Design("Enregistrer une donnee composee de type ArrayList", 3);
         ...
         tab.add(new Integer(-1));
            Tests.Unit(new Boolean (true),
                       new Boolean(Data.store(tab,"al","1.0.0")));
         }
      ...
      Tests.Design("Charger une donnee composee de type ArrayList", 3);
         Tests.Case("Cas nominal d'un tableau"); {
         ArrayList<Integer> tab2= (ArrayList<Integer>)Data.load("al","1.0.0");

            Tests.Unit(new Integer(-1), tab2.get(2));
         }
