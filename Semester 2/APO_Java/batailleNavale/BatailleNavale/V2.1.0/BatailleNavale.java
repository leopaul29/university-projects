...
// ---											Recupérer la lettre de la colone par le num
	...
	// ---									--- Methode enregistrerData et restaurerData ---
	//
	// --- 									Methode enregistrerData
    
    public static void enregistrerData() throws IOException {
    	
    	Joueur j1=null;
    	FileOutputStream fos1 = new FileOutputStream("joueur1.data");
    	BufferedOutputStream bos1 = new BufferedOutputStream(fos1);
    	ObjectOutputStream oos1 = new ObjectOutputStream(bos1);
    	try{oos1.writeObject(j1);}
    	catch(Exception e){}
    	finally{oos1.close();}
		
		Joueur j2=null;
    	FileOutputStream fos2 = new FileOutputStream("joueur2.data");
    	BufferedOutputStream bos2 = new BufferedOutputStream(fos2);
    	ObjectOutputStream oos2 = new ObjectOutputStream(bos2);
    	try{oos2.writeObject(j2);}
    	catch(Exception e){}
    	finally{oos2.close();}
    }
    
    // ---										Methode restaurerData
    
    public static Joueur restaurerDataj1(String FileName1, String FileName2) throws IOException {
    	
    	Joueur J1=null;
		ObjectInputStream ois1 = new ObjectInputStream(new BufferedInputStream(new FileInputStream(FileName1)));
		try {J1 = (Joueur) ois1.readObject();}
		catch(Exception e){}
		finally { ois1.close(); }
		return J1;
    
    	Joueur J2=null;
		ObjectInputStream ois2 = new ObjectInputStream(new BufferedInputStream(new FileInputStream(FileName2)));
		try {J2 = (Joueur) ois2.readObject();}
		catch(Exception e){}
		finally { ois2.close(); }
		return J2;
    }
