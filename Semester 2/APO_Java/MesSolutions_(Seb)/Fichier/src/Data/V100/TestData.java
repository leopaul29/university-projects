...
public static void main (String [] args) {     
   Tests.Begin("Data", "A - 1.0.0");
      ...
      Tests.Design("Charger une donnee composee", 3);
         ...
         Tests.Design("y pouetCas nomial d'un ArraylLis", 3);
         Tests.Case("Cas nominal d'un arrylist"); {
        	 
        	 ArrayList NinjaListe = new ArrayList();
        	 
        	 NinjaListe.add("Yo");
        	 NinjaListe.add("peuh");
        	 NinjaListe.add("La");
        	 
        	Tests.Unit(true, Data.store(NinjaListe, "Ninja", "1.0.0") );    	 
        	 
         }
         
         Tests.Case("Methode loadArray"); {
        	 
        	ArrayList NinjaListe = (ArrayList) Data.load("Ninja", "1.0.0");
        	
        	Tests.Unit("Yo", NinjaListe.get(0));
        	Tests.Unit("peuh", NinjaListe.get(1));
        	Tests.Unit("La", NinjaListe.get(2));
