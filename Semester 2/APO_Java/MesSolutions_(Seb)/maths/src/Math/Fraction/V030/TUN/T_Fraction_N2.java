...
package Math.Fraction.V030.TUN;
import Math.Teste.*;
import Math.Fraction.V030.*;

public class T_Fraction_N2 {

   public static void main (String[] args) throws Exception {

      Tests.Begin("_Maths.Fraction", "0.3.0");
         ...
         Tests.Design("Controle des accesseurs", 3); {
            ...
            Tests.Case("getValeur");
            {
               ...
               Tests.Unit(0.6666666666666666,  f1.getValeur());
               Tests.Unit(-0.6666666666666666, f2.getValeur());
               Tests.Unit(-2.00, f3.getValeur());
               Tests.Unit(0.6666666666666666,  f4.getValeur());
           	 }
