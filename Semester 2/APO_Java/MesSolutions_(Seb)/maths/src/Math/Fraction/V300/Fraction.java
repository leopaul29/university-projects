...
// + Version 2.0.0 : Ajout des méthodes équals et clone

// Auteur : S. Nicoletti


package Math.Fraction.V300;
import Math.Arithm.Arithm;
...
private static int m_compteur;
      ...
      public Fraction (double op2) throws Exception
   {
	...
	public Object clone()
	{
		...
		try
   	  {
   		clone = new Fraction(this.getNumerateur(),this.getDenominateur());
   	  }
      catch(Exception e){}
	...
	public boolean equals(Object f1)
	{
	    ...
	    return (this.getDenominateur() == f2.getDenominateur()) && (this.getNumerateur() == f2.getNumerateur());
	}
