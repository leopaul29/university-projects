...
public class Dessin {
	...
	protected LinkedHashMap<Date, String> m_historique;
	protected ArrayList<FormeGeo> m_formes;
	...
	public FormeGeo get (int indice){ return this.m_formes.get(indice); }
	...
	{
		Iterator<FormeGeo> i = this.m_formes.iterator();
		FormeGeo form = null;
