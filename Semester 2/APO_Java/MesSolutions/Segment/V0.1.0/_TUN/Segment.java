...
// Edition A        : TD5
//
// + Version 0.0.0 : TD5 constructeur, accesseur, methode clone, equals, extremite, horizontal, vertical, projX, projY
// + Version 0.1.0 : TD5 methode aligne, appartient, projOrthogonal
//
...
private final Point m_B;
   ...
   protected Object clone() {return new Segment(m_A, m_B);}
   ...
   public boolean extremite(final Point p) { return p.equals(m_A) || p.equals(m_B);}
