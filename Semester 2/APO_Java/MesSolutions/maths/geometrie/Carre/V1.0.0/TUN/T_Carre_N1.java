      ...
      Tests.Begin("Carre", "V 0.0.0");
          ...
          Tests.Design("Methode Clone et Equals", 3); {	
			...
			Tests.Case("Methode Clone"); {
				...
				Carre c1 = new Carre(2.3);
         		Carre c2= (Carre)c1.clone();

               	Tests.Unit(2,  Carre.getCompteur());
			...
			Tests.Case("Methode equals"); {
				...
				Carre c1 = new Carre(2.3);
				Carre c2 = new Carre(2.5);
	         	
	               	Tests.Unit(true, c1.equals(c1));
					Tests.Unit(true, c1.equals(c1.clone()));
					Tests.Unit(false, c1.equals(c2));
            }
		}
