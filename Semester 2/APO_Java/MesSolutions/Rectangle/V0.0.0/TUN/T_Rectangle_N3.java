   ...
   public static void main (String[] args) throws Exception {
      ...
      Tests.Begin("_Maths.Rectangle", "0.0.0");
         ...
         Tests.Design("Controle des methodes généraux", 3); {
         	...
         	try {
         		r = new Rectangle();
         		r1 = new Rectangle(2,6);
         		r2 = new Rectangle(3,4,0,0);
         		r3 = new Rectangle(p);
         		r4 = new Rectangle(p1,10,5);
         	}catch (Exception e){}
         		
         		Tests.Unit(true, r.estVide());
         		Tests.Unit(false, r1.estVide());
         		Tests.Unit(true, r2.estVide());
            ...
            Tests.Case("unionR");{
			Rectangle r1 = null;	Rectangle r4 = null;
			Rectangle r2 = null;	Rectangle r5 = null;
			Rectangle r3 = null;
			...
			r5=r1.intersectionR(r2);
			r4=r2.intersectionR(r3);
			
				Tests.Unit("[_(3.0, 4.0), 3.0, 1.0]", r4.toString());
				Tests.Unit("[_(3.0, 2.0), 1.0, 1.0]", r5.toString());
            }
         }
