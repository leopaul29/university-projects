		     ...
		     while(fenetre.getContinuerAppli())
		     {
		    		  ...
		    		  while(fenetre.getContinuerWebcam())
		    		  {
		    			  ...
		    			  while (  fenetre.getContinuerAppli() && fenetre.getContinuerWebcam())
		    			  {
		    				 ...
		    				 // imageParalele = video.getImageFlux().clone(); a remttre si on veut mettre le masque
		    				 
		    				  
		    				  //a voir !!!On masque le visage mais  ralentit le prog 
		    				/*  objetDetecte.suivreMain(imageParalele, masqueVisage);
		    				  masqueVisage.x(objetDetecte.x()-(masqueVisage.width()/2));
		    				  masqueVisage.y(objetDetecte.y()-(masqueVisage.height()/2));
		    				  ...
		    				  //on cherche la main sur l'image parallele
 								// objetDetecte.suivreMain(imageParalele, rect); //a remettre pour le masque
